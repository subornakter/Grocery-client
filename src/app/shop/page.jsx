...
export default function Shop() {
  ...
  useEffect(() => {
    fetch("https://grocery-project-server.vercel.app/shop")
      .then((res) => res.json())
      .then((data) => {
        setProducts(data);
  ...
  return (
    <div className="p-4 mx-auto max-w-7xl">
      <div className="mb-2 bg-gradient-to-r from-[#bfe30a] via-[#83e54e] to-[#5bb52a] bg-clip-text text-transparent text-3xl font-bold text-center">
        All Products
      </div>
      ...
      <div className="flex flex-col gap-4 mb-6 md:flex-row md:items-center md:justify-between">
        ...
        <div className="flex w-full gap-2 md:w-1/3">
          ...
          />
          <button
            className="px-4 py-2 text-white bg-[#78C841] rounded hover:bg-green-600 text-sm md:text-base"
          >
            Search
          </button>
        </div>
